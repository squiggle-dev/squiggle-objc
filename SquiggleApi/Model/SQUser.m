...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"_id", @"status", @"webhookUrl", @"email", @"companyName", @"firstName", @"lastName", @"domain", @"address1", @"address2", @"address3", @"addressCity", @"addressPostcode", @"addressCountry", @"website", @"tel", @"linkedin", @"facebook", @"twitter", @"instagram", @"googleplus", @"logo", @"snippet", @"template", @"snippetEnabled", @"secretKey", @"accessToken", @"createdAt", @"updatedAt"];
